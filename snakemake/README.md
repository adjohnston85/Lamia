...
snakemake --use-conda --profile slurm --config run_file=samples.tsv account='OD-220596' output_path=/datasets/work/hb-barretts-oesophagus-dx/work/analysis/emseq/03_test_rufus/snakemake/workflow whole_experiment=True trim_profile='em-seq' --cores 32 --rerun-triggers mtime
